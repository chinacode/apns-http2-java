...
public class ApnsServiceManager {
    ...
    public static long getPoolRunSize(){
        int size = 0;
        for(String key : serviceMap.keySet()){
            size += (100-serviceMap.get(key).size());
        }
        return size;
    }
