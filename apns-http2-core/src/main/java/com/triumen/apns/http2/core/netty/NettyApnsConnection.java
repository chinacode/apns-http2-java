package com.triumen.apns.http2.core.netty;

import com.triumen.apns.http2.core.model.PushNotification;
import com.triumen.apns.http2.core.netty.http2.Http2ClientInitializer;
import com.triumen.apns.http2.core.netty.http2.Http2SettingsHandler;
import com.triumen.apns.http2.core.netty.http2.HttpResponseHandler;
...
//                request.headers().add("com.triumen.apns-topic", topic);
//
//                // streamId过大,重新初始化
