...
public class ApnsConfig {
    ...
    private FailureMsgList failureMsgList;
...
//        return this.name != null && !"".equals(this.name.trim()) ? this.name : (this.isDevEnv() ? "dev-env" : "product-env");
    ...
    public FailureMsgList getFailureMsgList() {
        return failureMsgList;
    }

    public void setFailureMsgList(FailureMsgList failureMsgList) {
        this.failureMsgList = failureMsgList;
    }
}
